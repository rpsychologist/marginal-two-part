...
# Introduction
This document shows how to use R and brms to fit the marginal two-part gamma model used in the article, and it also presents an example of how to visualize and summarize the results. 
